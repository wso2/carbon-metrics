...
public class MetricsLevelConfigException extends Exception {
    ...
    public MetricsLevelConfigException(String message, Throwable cause) {
        super(message, cause);
    }

    public MetricsLevelConfigException(String message) {
        super(message);
    }

    public MetricsLevelConfigException(Throwable cause) {
        super(cause);
    }
