...
public class DASReporter extends ScheduledReporter {
    ...
    /**
     * A builder for {@link DASReporter} instances. Defaults to converting rates
    ...
    public static class Builder {
        ...
        /**
         * Builds a {@link DASReporter} with the given properties to report
         * metrics to DAS
         *
         * @param source
         *            A value to identify the source of each metrics
         * @param type
         * @param receiverURL
         * @param authURL
         * @param username
